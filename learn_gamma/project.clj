(defproject learn-gamma "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj" "yaks/gamma/src" "yaks/gamma-driver/src"]
                   :test-paths ["test/clj"]
                   ...
                   :repl-options {:init-ns learn-gamma.server
